...
// B4-4). Deactivating is the one move, and ends the person's sessions in the
// same transaction (ADR-003 §7, B4-5). The machine is written now because the
// database's status guard holds it from the first row (0015).
