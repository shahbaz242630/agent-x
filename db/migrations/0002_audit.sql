...
-- over the other columns; see packages/platform/src/audit-chain. The checks
-- here only keep honest mistakes out: someone with the owner's rights can drop
-- them, which is why the app checks every row it reads.
